                    ...
                    <div class="row">
                        ...
                        <div class="py-1 col-4">
                            ...
                            <select name="lstUsuario" id="lstUsuario" class="form-control" required>
                                <option value="" disabled selected>Seleccionar</option>
                                <option value="Ana" <?php echo isset($aTareas[$id]) && $aTareas[$id]["usuario"] == "Viviana" ? "selected" : "";?>>Viviana</option>
                                <option value="Bernabe" <?php echo isset($aTareas[$id]) && $aTareas[$id]["usuario"] == "Paula" ? "selected" : "";?>>Paula</option>
                                <option value="Daniela" <?php echo isset($aTareas[$id]) && $aTareas[$id]["usuario"] == "Heidy" ? "selected" : "";?>>Heidy</option>
                            </select>
                        </div>
                        <div class="py-1 col-4">
